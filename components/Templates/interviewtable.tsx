    ...
    <div className="space-y-2">
      <div className="flex justify-end">
        ...
        <Button className="hidden md:block w-[126px]" onClick={onclickExceldownload} size={'sm'} variant={"print"}
          ...
          <input
            className="border border-[#b5bfcb] dark:border-[#D0D5DD] px-1.5 dark:text-white py-1.5 dark:bg-input w-full md:w-2/4 rounded text-sm shadow focus:outline-none focus:ring ease-linear transition-all duration-150"
            type="text"
            value={globalFilter || ""}
